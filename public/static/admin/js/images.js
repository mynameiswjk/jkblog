            ...
            $.get(getPhotoDataUrl,function(res){
                ...
                setTimeout(function(){
                    for(var i=imgNums*(page-1); i<maxPage; i++){
                        imgList.push('<li><img layer-src="'+ data[i].photo_thumb +'" src="'+ data[i].photo_thumb +'" alt="'+data[i].photo_name+'"><div class="operate"><div class="check"><input type="checkbox" name="belle" lay-filter="choose" lay-skin="primary" title="'+data[i].photo_name+'"></div><i class="layui-icon img_del">&#xe640;</i></div></li>');
                    }
